...
def main(gpu    :Param("GPU to run on", int)=None,
         ...
         l      :Param("Target number of frames of the ResizeTime transform", int)=30,
         skip   :Param("skip frames",int)=4,
         size     :Param("size for Resize", int)=224,
         n_epoch:Param("# of epochs to train", int)=15,
         loss   :Param("Choose a loss between CEL-SCL and SCL ", str)='SCL',
         ...
         descr  :Param("description of the experiment", str)='First training with CE to have a preformance baseline',
         model: Param("model")='r2p1d50_K',
         normalize: Param('normalization')='kinetics'
        ):
