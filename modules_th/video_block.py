...
class UniformizedDataLoader(TfmdDL):
    ...
    def get_labeled_elements(self, lbl, n_el):
        ...
        while i < n_el:
            ...
            if item is not None: els_of_lbl.append(item); i += 1
        return els_of_lbl
    ...
    def create_batches(self, samps):
        ...
        while len(self.dl_vocab) >= n_lbl:
            ...
            inserted_lbls, succesful_lbls, b = 0, [], []

            while inserted_lbls < n_lbl:
                ...
                b.extend(els_of_lbl)
                succesful_lbls.append(lbl)
                inserted_lbls += 1

            self.dl_vocab.extend(succesful_lbls)
