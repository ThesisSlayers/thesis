# AUTOGENERATED! DO NOT EDIT! File to edit: UCF101_SupCon.ipynb (unless otherwise specified).
...
# Cell
def get_dls(dsets,splits,df, n_el= 4, n_lbl = 2, shuffle_fn= UniformizedShuffle):
...
# Cell
def get_learner(df, pretrained_model='r2p1d50_K',  loss='CEL-SCL', l=40, size=224, n_lbl =4, n_el=2, skip=20, embs_size=128,n_views=2):


    dsets,splits = get_dsets(df, l, size, skip, n_views)

    dls = get_dls(dsets,splits,df)
